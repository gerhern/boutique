                    ...
                    <tr class="group hover:bg-bg-elevated/30 transition-colors">
                        ...
                        <td class="px-6 py-4 text-right">
                            ...
                            <div x-show="editingId !== {{ $category->id }}" class="flex justify-end gap-3">
                                <button @click="editingId = {{ $category->id }}" class="text-content-secondary hover:text-accent transition-colors">
                                ...
                                <button @click="deleteCategory({{ $category->id }})" class="text-content-secondary hover:text-state-danger transition-colors">
